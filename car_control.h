...
extern volatile uint16_t g_entry_slow_ticks;    /* 从白区切入黑线时的强制减速计数器 */
extern volatile int16_t  g_entry_slow_speed;    /* 切入黑线瞬间的基准慢速 */
extern volatile int16_t  g_entry_max_steer;     /* 切入黑线瞬间的最大差速转向限制 */
extern volatile uint16_t g_entry_hold_ticks;    /* 强制不退出的“真空时间”/死区时间 (8 = 80ms) */
extern volatile uint16_t g_entry_max_ticks;     /* 抓线捕获期的最大超时时间 (40 = 400ms) */
